...
SOURCES = \
	__init__.py \
	theme_manager.py theme_manager_dialog.py

PLUGINNAME = theme_manager

PY_FILES = \
	__init__.py \
	theme_manager.py theme_manager_dialog.py

UI_FILES = theme_manager_dialog_base.ui
...
QGISDIR=C:\Users\boyer-a\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
